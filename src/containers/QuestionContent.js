...
// const mapStateToProps = state => ({form: state.form,questions: state.showData, currentQuestion: state.showCurrentQuestion, question: state.showData[state.showCurrentQuestion].question});
